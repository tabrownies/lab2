document.getElementById("weatherSubmit").addEventListener("submit", (event) => {
  ...
  document.getElementById("currentCity").style.color = 'initial';
...
function getCurrentWeather(place) {
  ...
  fetch(url)
    .then(function (response) {
      ...
      document.getElementById("currentCity").innerHTML = "Invalid City";
      document.getElementById("currentCity").style.color = 'red';
    });
